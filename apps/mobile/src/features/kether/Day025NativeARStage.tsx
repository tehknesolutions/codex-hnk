...
const NativeScene=Day025NativeARScene as unknown as()=>ReturnType<typeof Day025NativeARScene>;
export function Day025NativeARStage(props:Day025NativeARStageProps){return <View style={styles.root}><ViroARSceneNavigator style={styles.root} provider="none" autofocus initialScene={{scene:NativeScene}} viroAppProps={props}/></View>}
