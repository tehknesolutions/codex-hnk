...
export function classifyRgb(rgb, prototypes) {
...
export function averagePatch(data, width, height, centerX, centerY, radius = 4) {
  let r = 0;
  let g = 0;
  let b = 0;
  let count = 0;
...
export function sampleNinePatches(data, width, height) {
