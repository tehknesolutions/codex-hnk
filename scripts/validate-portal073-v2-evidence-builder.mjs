...
const runtime='apps/mobile/src/features/chokmah/runtime-definitions/portal073.ts';
const s=fs.readFileSync(p,'utf8');
const r=fs.readFileSync(runtime,'utf8');
const required=[
...
if(!r.includes("PORTAL073_SCHEMA_VERSION='HNK-PORTAL-073-EVIDENCE-V1'"))missing.push('runtime_schema_version');
