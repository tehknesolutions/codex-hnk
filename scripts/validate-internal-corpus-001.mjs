...
if(b.sources.length!==7)fail("expected 7 repos");if(n!==15)fail("expected 15 concepts, got "+n);
console.log("HNK_INTERNAL_CORPUS_001_PASS: 7 repositories / 15 concepts");
