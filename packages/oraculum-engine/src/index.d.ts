...
export interface CanonicalOracleCommit {
  protocol: string;
  profileId: string;
  mode: OraculumMode;
  intent: string;
...
export interface OracleResult {
  ...
  profileId: string;
  mode: OraculumMode;
  canonicalInput: Readonly<{ intent: string; cubeState: string; moves: string }>;
  commit: string;
  raw: Readonly<{ seed256: string; hex: string; binary: string }>;
  iching: Readonly<Record<string, unknown>>;
  path32: Readonly<{ index: number; sourceBits: string }>;
  hnk: Readonly<Record<string, unknown>>;
  tarot: Readonly<Record<string, unknown>>;
  astrology: Readonly<Record<string, unknown>>;
  alchemy: Readonly<Record<string, unknown>>;
  numerology: Readonly<Record<string, unknown>>;
  colors: Readonly<Record<string, unknown>>;
  synthesisVector: Readonly<Record<string, unknown>>;
  derivationReservoir: string;
  sigil: Readonly<Record<string, unknown>>;
