...
export type AuthoredCandidateCertainty = 'AUTHORED_DERIVATION'|'AUTHORED_BACK_ANALYSIS'|'AUTHORED_DERIVATION_WITH_GATED_COMPONENT'|'AUTHORED_PRIMITIVE'|'AUTHORED_EVIDENCE_MAPPING';
