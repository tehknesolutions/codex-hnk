...
export function parseElemiahFragment(crown:unknown):ElemiahFragmentState{
...
export function assertElemiahProgress(crown:unknown,expectedCompletedDays:number):ElemiahFragmentState{
